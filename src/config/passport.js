  ...
  passport.use(
    ...
    new JwtStrategy(
      ...
      async (jwt_payload, done) => {
        try {
          console.log('Passport Jason Web Token Successful - payload:', jwt_payload);
    ...
    new LocalStrategy(
      ...
      async (req, username, password, done) => {
        ...
        try {
          ...
          if (user) {
            console.log('Passport Register alert. "User already exists"');
          ...
          const data = newUser;
          console.log('Passport Register successful. "Registered user"', data);
      ...
      async (req, username, password, done) => {
        try {
          if (username === 'adminCoder@coder.com' && password === 'adminCod3r123') {
            ...
            console.log('Passport Admin Login successful', adminUser);
